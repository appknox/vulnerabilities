CCCryptor の使用で、 AES, 3DES のような異なるアルゴリズムと RC4, DES などのようなハードコアセキュリティサイファーを使用して対称的な暗号化を実行するための CCCryptorCreate, CCCryptorUpdate, CCCryptorFinal (あるいは単に CCCrypt() one-shot 機能) のような共通範囲の機能を使用することが出来ます。
